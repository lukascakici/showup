...
export default function SendPage() {
  const { status, openPicker, walletName, wrongNetwork, error } = useWallet();
    ...
    <div className="flex flex-col gap-6">
      ...
      <section>
        ...
        <p className="mt-2 max-w-md text-base text-muted">
          Move a deposit to any Stellar Testnet address. You&apos;ll sign in your
          wallet and get a transaction hash.
        </p>
      </section>
        ...
        <Card className="flex flex-col items-start gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-muted">
              Connect a Stellar wallet on Testnet to send a payment.
            </p>
          </div>
          ...
          {wrongNetwork && (
            <div className="flex items-start gap-3 rounded-xl border border-danger/40 bg-surface-2 p-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted">
                  Switch {walletName ?? "your wallet"} to <strong>Testnet</strong> to
                  send a payment.
                </p>
              </div>
            </div>
