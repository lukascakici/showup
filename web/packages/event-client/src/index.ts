...
export interface Client {
   ...
   * `finalize`.
   */
  initialize: ({organizer, token, deposit, fee_allowance, capacity, code_hash, policy, reputation}: {organizer: string, token: string, deposit: i128, fee_allowance: i128, capacity: u32, code_hash: Buffer, policy: ForfeitPolicy, reputation: Option<string>}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "",
        ...
        "",
